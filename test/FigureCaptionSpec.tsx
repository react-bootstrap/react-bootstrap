...
describe('<Figure.Caption>', () => {
  ...
  it('has "figure-caption" class', () => {
    ...
    getByTestId('test-figure').classList.contains('figure-caption').should.be.true;
  });

  it('Should merge additional classes passed in', () => {
    const { getByTestId } = render(
      <Figure.Caption className="bob" data-testid="test-figure">Caption</Figure.Caption>
    )
  ...
  it('allows custom elements instead of "figcaption"', () => {
    const { getByTestId } = render(
      <Figure.Caption as="section" data-testid="test-figure">Caption</Figure.Caption>
    )
