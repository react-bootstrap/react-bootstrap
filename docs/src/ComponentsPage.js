          ...
          <div className="row">
            <div className="col-md-9" role="main">
              ...
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="buttons">Buttons</Anchor>
                  <small>Button</small>
                </h1>
                <h2><Anchor id="buttons-options">Options</Anchor></h2>

                <p>Use any of the available button style types to quickly create a styled button. Just modify the <code>bsStyle</code>
                  prop.</p>
                ...
                <p>Fancy larger or smaller buttons? Add <code>bsSize="large"</code>, <code>bsSize="small"</code>, or
                  <code>bsSize="xsmall"</code> for additional sizes.</p>
              ...
              {/* Button Groups */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="btn-groups">Button groups</Anchor>
                ...
                <p>Combine sets of <code>{"<ButtonGroup />"}</code>s into a <code>{"<ButtonToolbar />"}</code> for more
                  complex components.</p>
                <ReactPlayground codeText={Samples.ButtonToolbarBasic}/>

                <h3><Anchor id="btn-groups-sizing">Sizing</Anchor></h3>

                <p>Instead of applying button sizing props to every button in a group, just add <code>bsSize</code> prop
                  to the <code>{"<ButtonGroup />"}</code>.</p>
                ...
                <p>Moreover, you can have buttons be block level elements so they take the full width of their
                  container, just add <code>block</code> to the <code>{"<ButtonGroup />"}</code>, in addition to the
                  <code>vertical</code> you just added.</p>
                <ReactPlayground codeText={Samples.ButtonGroupBlock}/>

                <h3><Anchor id="btn-groups-justified">Justified button groups</Anchor></h3>

                <p>Make a group of buttons stretch at equal sizes to span the entire width of its parent. Also works
                  with button dropdowns within the button group.</p>

                <div className="bs-callout bs-callout-warning">
                  <h4>Style issues</h4>

                  <p>There are some issues and workarounds required when using this property, please see <a
                    href="http://getbootstrap.com/components/#btn-groups-justified">bootstrap&#8217;s button group
                    docs</a> for more specifics.</p>
                </div>
              ...
              <div className="bs-docs-section">
                ...
                <p className="lead">Use <code>{"<DropdownButton />"}</code> or <code>{"<SplitButton />"}</code>
                  components to display a button with a dropdown menu.</p>
                ...
                <p>Trigger dropdown menus that align to the right of the button using the <code>pullRight</code> prop.
                </p>
                ...
                <p>
                  ...
                  at least one component with <code>bsRole="toggle"</code> and exactly one with
                  <code>bsRole="menu"</code>.
                </p>
              ...
              {/* Menu Item */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="menu-item">Menu Item</Anchor>
                  <small> MenuItem</small>
                </h1>
                <p>This is a component used in other components (see <a href="buttons">Buttons</a>, <a href="#navbars">Navbars</a>).
                </p>

                <p>It supports the basic anchor properties <code>href</code>, <code>target</code>, <code>title</code>.
                </p>
                ...
                <p>It also supports different properties of the normal Bootstrap MenuItem.
                  ...
                  <p>The callback is called with the following arguments: <code>eventKey</code>, <code>href</code> and
                    <code>target</code></p>
                </p>
              ...
              {/* Panels */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="panels">Panels</Anchor>
                  <small>Panel, PanelGroup, Accordion</small>
                </h1>

                <h3><Anchor id="panels-basic">Basic example</Anchor></h3>

                <p>By default, all the <code>&lt;Panel /&gt;</code> does is apply some basic border and padding to
                  contain some content.</p>

                <p>You can pass on any additional properties you need, e.g. a custom <code>onClick</code> handler, as it
                  is shown in the example code. They all will apply to the wrapper <code>div</code> element.</p>
                ...
                <p>Pass buttons or secondary text in the <code>footer</code> prop. Note that panel footers do not
                  inherit colors and borders when using contextual variations as they are not meant to be in the
                  foreground.</p>
                <ReactPlayground codeText={Samples.PanelWithFooter}/>

                <h3><Anchor id="panels-contextual">Contextual alternatives</Anchor></h3>

                <p>Like other components, easily make a panel more meaningful to a particular context by adding a <code>bsStyle</code>
                  prop.</p>
                <ReactPlayground codeText={Samples.PanelContextual}/>

                <h3><Anchor id="panels-tables">With tables and list groups</Anchor></h3>

                <p>Add the <code>fill</code> prop to <code>&lt;Table /&gt;</code> or <code>&lt;ListGroup /&gt;</code>
                  elements to make them fill the panel.</p>
                <ReactPlayground codeText={Samples.PanelListGroupFill}/>

                <h3><Anchor id="panels-controlled">Controlled PanelGroups</Anchor></h3>

                <p><code>PanelGroup</code>s can be controlled by a parent component. The <code>activeKey</code> prop
                  dictates which panel is open.</p>
                <ReactPlayground codeText={Samples.PanelGroupControlled}/>

                <h3><Anchor id="panels-uncontrolled">Uncontrolled PanelGroups</Anchor></h3>

                <p><code>PanelGroup</code>s can also be uncontrolled where they manage their own state. The <code>defaultActiveKey</code>
                  prop dictates which panel is open when initially.</p>
              ...
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="modals">Modals</Anchor>
                  <small>Modal</small>
                </h1>
                ...
                <p>
                  A modal with header, body, and set of actions in the footer. Use <code>{"<Modal/>"}</code> in
                  combination with other components to
                  show or hide your Modal. The <code>{"<Modal/>"}</code> Component comes with
                  a few convenient "sub components": <code>{"<Modal.Header/>"}</code>, <code>{"<Modal.Title/>"}</code>,
                ...
                <div className="bs-callout bs-callout-info">
                  ...
                  <p>
                    ...
                    <code>{"<Modal/>"}</code> component, but you can also,
                    import them directly from the <code>/lib</code> directory like:
                ...
                <p>You will need to add the following css to your project and ensure that your container has the <code>modal-container</code>
                  class.</p>
                  <pre>
                    {React.DOM.code(null,
                      '.modal-container {\n' +
                ...
                <p>You can apply custom css to the modal dialog div using the "dialogClassName" prop. Example is using a
                  custom css class with width set to 90%.</p>
              ...
              <div className="bs-docs-section">
                ...
                <p>The Popover component, like the Tooltip can be used with an <code>OverlayTrigger</code> Component,
                  and positioned around it.</p>
                <ReactPlayground codeText={Samples.PopoverPositioned}/>

                <h4><Anchor id="popovers-trigger-behaviors">Trigger behaviors</Anchor></h4>

                <p>It"s inadvisable to use <code>"hover"</code> or <code>"focus"</code> triggers for popovers, because
                  they have poor accessibility from keyboard and on mobile devices.</p>
                ...
                <h4><Anchor id="popovers-positioned-scrolling">Positioned popover components in scrolling
                  container</Anchor></h4>
                <ReactPlayground codeText={Samples.PopoverPositionedScrolling}
              ...
              <div className="bs-docs-section">
                ...
                <p>
                  The <code>OverlayTrigger</code> component is great for most use cases, but as a higher level
                  abstraction it can lack the flexibility needed
                  to build more nuanced or custom behaviors into your Overlay components. For these cases it can be
                  helpful to forgo the trigger and use
                ...
                <p>
                  You don"t need to use the provided <code>Tooltip</code> or <code>Popover</code> components. Creating
                  custom overlays
              ...
              {/* Progress Bar */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="progress">Progress bars</Anchor>
                  <small>ProgressBar</small>
                </h1>

                <p className="lead">Provide up-to-date feedback on the progress of a workflow or action with simple yet
                  flexible progress bars.</p>
                ...
                <p>Add a <code>label</code> prop to show a visible percentage. For low percentages, consider adding a
                  min-width to ensure the label"s text is fully visible.</p>

                <p>The following keys are interpolated with the current values: <code>%(min)s</code>,
                  <code>%(max)s</code>, <code>%(now)s</code>, <code>%(percent)s</code>, <code>%(bsStyle)s</code></p>
                ...
                <p>Add <code>active</code> prop to animate the stripes right to left. Not available in IE9 and below.
                </p>
              ...
              {/* Nav */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="navs">Navs</Anchor>
                  <small>Nav, NavItem</small>
                </h1>

                <p>Navs come in two styles, <code>pills</code> and <code>tabs</code>. Disable a tab by adding <code>disabled</code>.
                </p>
                <ReactPlayground codeText={Samples.NavBasic}/>

                <h3><Anchor id="navs-dropdown">Dropdown</Anchor></h3>

                <p>Add dropdowns using the <code>DropdownButton</code> component. Just make sure to set
                  <code>navItem</code> property to true.</p>
              ...
              {/* Navbar */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="navbars">Navbars</Anchor>
                  <small>Navbar, Nav, NavItem</small>
                </h1>

                <p>Navbars are by default accessible and will provide <code>role="navigation"</code>.</p>

                <p>They also supports all the different Bootstrap classes as properties. Just camelCase the css class
                  and remove navbar from it. For example <code>navbar-fixed-top</code> becomes the property <code>fixedTop</code>.
                  The different properties are <code>fixedTop</code>, <code>fixedBottom</code>, <code>staticTop</code>,
                  <code>inverse</code>, <code>fluid</code>.</p>
                ...
                <p>You can specify a brand by passing in a string to <code>brand</code>, or you can pass in a renderable
                  component.</p>
                <ReactPlayground codeText={Samples.NavbarBrand}/>

                <h3><Anchor id="navbars-mobile-friendly">Mobile Friendly</Anchor></h3>

                <p>To have a mobile friendly Navbar, specify the property <code>toggleNavKey</code> on the Navbar with a
                  value corresponding to an <code>eventKey</code> of one of his <code>Nav</code> children. This child
                  will be the one collapsed.</p>

                <p>By setting the property {React.DOM.code(null, 'defaultNavExpanded')} the Navbar will start expanded
                  by default.</p>

                <div className="bs-callout bs-callout-info">
                  <h4>Scrollbar overflow</h4>

                  <p>The height of the collapsible is slightly smaller than the real height. To hide the scroll bar, add
                    the following css to your style files.</p>
                    <pre>
                      {React.DOM.code(null,
                        '.navbar-collapse {\n' +
                        '  overflow: hidden;\n' +
                ...
                <h3><Anchor id="navbars-mobile-friendly-multiple">Mobile Friendly (Multiple Nav Components)</Anchor>
                </h3>

                <p>To have a mobile friendly Navbar that handles multiple <code>Nav</code> components use <code>CollapsibleNav</code>.
                  The <code>toggleNavKey</code> must still be set, however, the corresponding <code>eventKey</code> must
                  now be on the <code>CollapsibleNav</code> component.</p>

                <div className="bs-callout bs-callout-info">
                  <h4>Div collapse</h4>

                  <p>The <code>navbar-collapse</code> div gets created as the collapsible element which follows the <a
                    href="http://getbootstrap.com/components/#navbar-default">bootstrap</a> collapsible navbar
                    documentation.</p>
              ...
              {/* Tabbed Areas */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="tabs">Togglable tabs</Anchor>
                  <small>Tabs, Tab</small>
                </h1>
                ...
                <p>Set <code>position</code> to <code>"left"</code>. Optionally, <code>tabWidth</code> can be passed the
                  number of columns for the tabs.</p>
              ...
              {/* Pager */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="pager">Pager</Anchor>
                  <small>Pager, PageItem</small>
                </h1>
                ...
                <p>Set the <code>previous</code> or <code>next</code> prop to <code>true</code>, to align left or right.
                </p>
              ...
              {/* Pagination */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="pagination">Pagination</Anchor>
                  <small>Pagination</small>
                </h1>

                <p>Provide pagination links for your site or app with the multi-page pagination component. Set <code>items</code>
                  to the number of pages. <code>activePage</code> prop dictates which page is active</p>
                <ReactPlayground codeText={Samples.PaginationBasic}/>

                <h4><Anchor id="pagination-more">More options</Anchor></h4>

                <p>such as <code>first</code>, <code>last</code>, <code>previous</code>, <code>next</code> and <code>ellipsis</code>.
                </p>
              ...
              {/* Alerts */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="alerts">Alert messages</Anchor>
                  <small>Alert</small>
                </h1>
              ...
              {/* Carousels */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="carousels">Carousels</Anchor>
                  <small>Carousel, CarouselItem</small>
                </h1>
              ...
              {/* Affix */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="affix">Affix</Anchor>
                  <small>Affix</small>
                </h1>

                <h3><Anchor id="affix">Affix</Anchor></h3>

                <p>The subnavigation on the right is a live demo of the affix plugin.Change the code below will affect the subnavigation's behaive.</p>

                <ReactPlayground codeText={Samples.Affix} mountTarget="affix-target" exampleClassName="bs-example-tabs"/>

                <h3><Anchor id="affix-props">Props</Anchor></h3>

                <h4><Anchor id="affix-props-affix">Affix</Anchor></h4>
                <PropTable component="Affix"/>

              </div>

              {/* Grids */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="grids">Grids</Anchor>
                  <small>Grid, Row, Col</small>
                </h1>
              ...
              <div className="bs-docs-section">
                ...
                <p>Thumbnails are designed to showcase linked images with minimal required markup. You can extend the
                  grid component with thumbnails.</p>
              ...
              {/* ListGroup */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="listgroup">List group</Anchor>
                ...
                <p>Set the <code>href</code> or <code>onClick</code> prop on <code>ListGroupItem</code>, to create a
                  linked or clickable element.</p>
                <ReactPlayground codeText={Samples.ListGroupLinked}/>

                <h3><Anchor id="listgroup-styling-state">Styling by state</Anchor></h3>

                <p>Set the <code>active</code> or <code>disabled</code> prop to <code>true</code> to mark or disable the
                  item.</p>
              ...
              <div className="bs-docs-section">
                ...
                <p>Easily highlight new or unread items by adding a <code>{"<Badge>"}</code> to links, Bootstrap navs,
                  and more.</p>
              ...
              <div className="bs-docs-section">
                ...
                <p>A lightweight, flexible component that can optionally extend the entire viewport to showcase key
              ...
              <div className="bs-docs-section">
                ...
                <p>A simple shell for an <code>h1</code> to appropriately space out and segment sections of content on a
                  page. It can utilize the <code>h1</code>&#8217;s default <code>small</code> element, as well as most
                  other components (with additional styles).</p>
              ...
              <div className="bs-docs-section">
                ...
                <p>Use the <code>striped</code>, <code>bordered</code>, <code>condensed</code> and <code>hover</code>
                  props to customise the table.</p>
                <ReactPlayground codeText={Samples.TableBasic}/>

                <h2><Anchor id="table-responsive">Responsive</Anchor></h2>

                <p>Add <code>responsive</code> prop to make them scroll horizontally up to small devices (under 768px).
                  When viewing on anything larger than 768px wide, you will not see any difference in these tables.</p>
              ...
              <div className="bs-docs-section">
                ...
                <p>Renders an input in bootstrap wrappers. Supports label, help, text input add-ons, validation and use
                  as wrapper.
                  Use <code>getValue()</code> or <code>getChecked()</code> to get the current state.
                  The helper method <code>getInputDOMNode()</code> returns the internal input element. If you don"t want
                  the <code>form-group</code> class applied apply the prop named <code>standalone</code>.</p>
                <ReactPlayground codeText={Samples.Input}/>

                <h3><Anchor id="input-types">Types</Anchor></h3>

                <p>Supports <code>select</code>, <code>textarea</code>, as well as standard HTML input types. <code>getValue()</code>
                  returns an array for multiple select.</p>
                <ReactPlayground codeText={Samples.InputTypes}/>

                <h3><Anchor id="input-static">FormControls.Static</Anchor></h3>

                <p>Static text can be added to your form controls through the use of the
                  <code>FormControls.Static</code> component.</p>
                <ReactPlayground codeText={Samples.StaticText}/>

                <h3><Anchor id="button-input-types">Button Input Types</Anchor></h3>

                <p>Form buttons are encapsulated by <code>ButtonInput</code>. Pass in <code>type="reset"</code> or
                  <code>type="submit"</code> to suit your needs. Styling is the same as <code>Button</code>.</p>
                <ReactPlayground codeText={Samples.ButtonInput}/>

                <h3><Anchor id="input-addons">Add-ons</Anchor></h3>

                <p>Use <code>addonBefore</code> and <code>addonAfter</code> for normal addons, <code>buttonBefore</code>
                  and <code>buttonAfter</code> for button addons.
                ...
                <p>Use <code>bsSize</code> to change the size of inputs. It also works with addons and most other
                  options.</p>
                ...
                <p>Set <code>bsStyle</code> to one of <code>success</code>, <code>warning</code> or <code>error</code>.
                  Add <code>hasFeedback</code> to show glyphicon. Glyphicon may need additional styling if there is an
                  add-on or no label.</p>
                <ReactPlayground codeText={Samples.InputValidation}/>

                <h3><Anchor id="input-horizontal">Horizontal forms</Anchor></h3>

                <p>Use <code>labelClassName</code> and <code>wrapperClassName</code> properties to add col classes
                  manually.
                  <code>checkbox</code> and <code>radio</code> types need special treatment because label wraps input.
                </p>
              ...
              {/* Utilities */}
              <div className="bs-docs-section">
                <h1 className="page-header"><Anchor id="utilities">Utilities</Anchor>
                  <small>Portal, Position</small>
                </h1>

                <h2><Anchor id="utilities-portal">Portal</Anchor></h2>

                <p>
                  A Component that renders its children into a new React "subtree" or <code>container</code>. The Portal
                  component kind of like the React
                  equivalent to jQuery"s <code>.appendTo()</code>, which is helpful for components that need to be
                  appended to a DOM node other than
                ...
                <p>
                  A Component that absolutely positions its child to a <code>target</code> component or DOM node. Useful
                  for creating custom
