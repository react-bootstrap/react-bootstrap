/* eslint-disable no-path-concat, key-spacing, global-require */
...
module.exports = {
  ...
  FormControls:                  require('fs').readFileSync(`${__dirname}/../examples/FormControls.js`, 'utf8'),
  FormHorizontal:                require('fs').readFileSync(`${__dirname}/../examples/FormHorizontal.js`, 'utf8'),
  FormInline:                    require('fs').readFileSync(`${__dirname}/../examples/FormInline.js`, 'utf8'),
  FormInputAddons:               require('fs').readFileSync(`${__dirname}/../examples/FormInputAddons.js`, 'utf8'),
  FormInputSizes:                require('fs').readFileSync(`${__dirname}/../examples/FormInputSizes.js`, 'utf8'),
