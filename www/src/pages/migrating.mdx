...
React-bootstrap _only_ contains components that are present vanilla bootstrap. If something
was removed from bootstrap it was also removed from react-bootstrap. This guide does not
repeat info found in the upstream migration guide, it's goal is to document react-bootstrap
specific API changes and additions
