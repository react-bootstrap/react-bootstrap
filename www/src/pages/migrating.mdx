...
Because there is still a lot of project depending on bootstrap 3 and
react-bootstrap's support, we will continue to provide general maintainance
for the bootstrap 3 components for a while. `react-bootstrap` package versions will be as follows:
