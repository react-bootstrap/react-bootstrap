...
import NavbarBasic from '../../examples/NavbarBasic';
import NavbarCollapsible from '../../examples/NavbarCollapsible';
import NavbarForm from '../../examples/NavbarForm';
import NavbarTextLink from '../../examples/NavbarTextLink';
...
export default function NavbarSection({ data }) {
  return (
    <div className="bs-docs-section">
      ...
      <p>
        They also support all the different Bootstrap classes as properties.
        Just camelCase the css class and remove navbar from it.
      </p>
      <p>
      ...
      <p>
        ...
        <code>pullRight</code> prop on the <code>Nav</code>, and other
        sub-components.
      </p>
      ...
      <p>
        To have a mobile friendly Navbar, Add a <code>Navbar.Toggle</code> to
        your Header and wrap your Navs in a <code>Navbar.Collapse</code>{' '}
        component. The <code>Navbar</code> will automatically wire the toggle
      ...
      <p>
        Use the <code>Navbar.Form</code> convenience component to apply proper
        margins and alignment to form components.
      </p>
      ...
      <p>
        Loose text and links can be wraped in the convenience components:{' '}
        <code>Navbar.Link</code> and <code>Navbar.Text</code>
      </p>
