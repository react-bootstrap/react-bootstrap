...
Spinners can be used as an indicator which notify user that some stuffs are being about to load on the page. It is better to show spinners instead of displaying blank pages before user dropping its interest and navigate.
