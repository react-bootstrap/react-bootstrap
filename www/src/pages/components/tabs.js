...
export default function TabsSection({ data }) {
  return (
    <div className="bs-docs-section">
      ...
      <ReactPlayground codeText={TabsUncontrolled} exampleClassName="bs-example-tabs" />
      ...
      <ReactPlayground codeText={TabsNoAnimation} exampleClassName="bs-example-tabs" />

      <h3><Anchor id="tabs-with-dropdown">Tabs with Dropdown</Anchor></h3>
      <ReactPlayground codeText={TabsWithDropdown} exampleClassName="bs-example-tabs" />
