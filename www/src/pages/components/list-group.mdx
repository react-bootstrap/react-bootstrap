...
import ListGroupCascadeActive from '../../examples/ListGroup/CascadeActive';
...
Set the `cascadeactive` if you want the props to cascade down to child components. 

<ReactPlayground
  codeText={ListGroupCascadeActive}
  exampleClassName={styles.listGroup}
/>
