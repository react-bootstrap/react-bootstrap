...
There's also a possiblity to render a checkbox in an indeterminate state.
*Note: Since 'indeterminate' state relies on imperative useEffect logic, it cannot be used in SSR context.*
