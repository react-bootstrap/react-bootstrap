...
With certain React-Bootstrap components you can specify a custom elementType 
to be passed with the 'as' Prop.

This can be especially useful if you want to combine the functionality 
and styling of two seperate components into one combined component.
