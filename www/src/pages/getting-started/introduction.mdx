...
In order for react-bootstrap components to be styled correctly, bootstrap's css must be imported 
somewhere in your project (usually in the entry point of your program).
