      ...
      return (
        <div>
          <div className="bs-docs-section">
            ...
            <h2>Stylesheets</h2>
            <p>
              Because React-Bootstrap doesn't depend on a very precise version
              of Bootstrap, we don't ship with any included css. However, some
              stylesheet <strong>is required</strong> to use these components.
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/latest/css/bootstrap-theme.min.css">
          `}
            ...
            />
            <p>
              For more advanced use cases you can also use a bundler like
              Webpack or Browserify to include the css files for you as part of
              your build process but that is beyond the scope of this guide.
              Also see{' '}
            ...
            <div className="bs-callout bs-callout-info">
              ...
              <p>
                If you install React-Bootstrap using <strong>npm</strong>, you
                can import individual components from{' '}
                <code>react-bootstrap/lib</code> rather than the entire library.
                Doing so pulls in only the specific components that you use,
                which can significantly reduce the size of your client bundle.
              </p>
            </div>
            <h3>
            ...
            <pre>
              <code>
                var Alert = require('react-bootstrap/lib/Alert'); // or var
...
...
            ...
            <p>
              ...
              <a href="https://cdnjs.com/libraries/react-bootstrap">CDNJS</a>,
